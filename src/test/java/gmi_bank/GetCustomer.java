...
public class GetCustomer extends GmiBankBaseUrl {
    ...
    //DIKKAT!! KAc tane Ojo lazim oldugunu "{}" lere bakarak anlarsin fakat eger "[]" varsa bu bir list demektir. Yani icinde 100
        // tane eleman veya süslü parantez olabilir fakat yine de bu bir list oldugu icin 1 tane pojo yeterlidir.
        // Yani "[]" nun icindeki "{}" larin kac tane oldugunun bir önemi yok. Bunun icin bir list olusturup bu list icin bir pojo olusturmak yeterli olacaktir
